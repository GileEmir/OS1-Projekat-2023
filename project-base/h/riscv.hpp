...
public:
    ...
    static void supervisorTrap(); // funkcija kojom obrađujemo sve prekide

    static void handleTimer(); // obrada prekidne rutine prouzrukovane tajmerom

    static void handleConsole(); // obrada prekidne rutine prouzrokovane konzolom

    static void handleInterrupt(); // obrada prekidne rutine prouzrokovane izuzetkom
